...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_checkbox_locales" ADD CONSTRAINT "forms_blocks_checkbox_locales__parent_id_forms_blocks_checkbox_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_checkbox"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_country_locales" ADD CONSTRAINT "forms_blocks_country_locales__parent_id_forms_blocks_country_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_country"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_email_locales" ADD CONSTRAINT "forms_blocks_email_locales__parent_id_forms_blocks_email_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_email"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_message_locales" ADD CONSTRAINT "forms_blocks_message_locales__parent_id_forms_blocks_message_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_message"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_number_locales" ADD CONSTRAINT "forms_blocks_number_locales__parent_id_forms_blocks_number_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_number"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_select_options_locales" ADD CONSTRAINT "forms_blocks_select_options_locales__parent_id_forms_blocks_select_options_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_select_options"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_select_locales" ADD CONSTRAINT "forms_blocks_select_locales__parent_id_forms_blocks_select_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_select"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_state_locales" ADD CONSTRAINT "forms_blocks_state_locales__parent_id_forms_blocks_state_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_state"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_text_locales" ADD CONSTRAINT "forms_blocks_text_locales__parent_id_forms_blocks_text_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_text"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
...
DO $$ BEGIN
 ALTER TABLE "forms_blocks_textarea_locales" ADD CONSTRAINT "forms_blocks_textarea_locales__parent_id_forms_blocks_textarea_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "forms_blocks_textarea"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
