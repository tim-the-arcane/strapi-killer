...
DO $$ BEGIN
 ALTER TABLE "posts_locales" ADD CONSTRAINT "posts_locales__parent_id_posts_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "posts"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
